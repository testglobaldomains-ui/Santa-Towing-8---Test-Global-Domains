                  ...
                  <div className="p-6 sm:p-8 flex-1 flex flex-col relative z-10 bg-white">
                    ...
                    <div className="mt-auto pt-4 border-t border-dark/10 space-y-3">
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <Link to={servicePath} className="flex-1 bg-primary hover:bg-black text-white text-center py-2 px-2.5 text-xs font-bold transition-all flex items-center justify-center rounded-[50px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary rounded-[1px] overflow-hidden flex flex-col md:flex-row relative">
            <div className="md:w-1/2 p-8 md:p-16 flex flex-col justify-center relative z-10 text-white">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary/20 text-accent font-bold text-xs uppercase tracking-wider mb-6 self-start rounded-[50px]">
                Featured Service
              </div>
              ...
              <button className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-lg self-start rounded-[50px]">
                Request a Tow Now
              </button>
            </div>
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-[50px]">
              Contact Us
            </Link>
            <a href="tel:0244753849" className="bg-white hover:bg-dark/5 text-dark px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-[50px]">
              Call Now
            </a>
          </div>
        </div>
