            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 py-6 border-y border-dark/10 mb-12">
              <div className="flex flex-wrap gap-2">
                ...
                {article.tags.map((tag, idx) => (
                  <Link key={idx} to="/blog" className="bg-slate-100 hover:bg-slate-200 text-dark/70 hover:text-dark text-xs font-bold px-3 py-1.5 transition-colors rounded-[50px]">
                    {tag}
                  </Link>
                ))}
              </div>
              <div className="flex items-center gap-3">
                ...
                <button className="w-9 h-9 bg-slate-100 flex items-center justify-center hover:bg-[#1877F2] hover:text-white transition-colors text-dark/60 rounded-[50px]"><Facebook className="w-4 h-4" /></button>
                <button className="w-9 h-9 bg-slate-100 flex items-center justify-center hover:bg-[#1DA1F2] hover:text-white transition-colors text-dark/60 rounded-[50px]"><Twitter className="w-4 h-4" /></button>
                <button className="w-9 h-9 bg-slate-100 flex items-center justify-center hover:bg-[#0A66C2] hover:text-white transition-colors text-dark/60 rounded-[50px]"><Linkedin className="w-4 h-4" /></button>
                <button className="w-9 h-9 bg-slate-100 flex items-center justify-center hover:bg-dark hover:text-white transition-colors text-dark/60 rounded-[50px]"><Link2 className="w-4 h-4" /></button>
              </div>
            </div>
            
            {/* 6. Contact / Service CTA Box */}
            <div className="bg-primary text-white rounded-[1px] p-8 shadow-xl relative overflow-hidden mb-12">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-col gap-3 w-full md:w-auto shrink-0">
                  <a href="tel:0244753849" className="bg-accent hover:bg-accent/90 text-white font-bold px-6 py-3 text-center transition-all shadow-md rounded-[50px]">
                    Call 0244 753 849
                  </a>
                  <Link to="/towing" className="bg-white/10 hover:bg-white/20 text-white font-bold px-6 py-3 text-center transition-all rounded-[50px]">
