    ...
    <main className="pt-24 lg:pt-[104px]">
      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-20 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <button className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-lg shadow-accent/30 rounded-[50px]">
              View Inventory
            </button>
            <button className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md px-8 py-4 font-bold transition-all border border-white/20 rounded-[50px]">
              Sell Your Car
            </button>
          </motion.div>
          ...
          >
            <form className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 items-end" onSubmit={e => e.preventDefault()}>
              ...
              <div className="col-span-2 md:col-span-1">
                <button className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-3 transition-all shadow-md flex items-center justify-center gap-2 rounded-[50px]">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            ...
            <button 
              className="md:hidden w-full flex items-center justify-center gap-2 bg-white border border-dark/20 py-3 font-bold text-dark shadow-sm rounded-[50px]"
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className={cn(
              ...
              <div className="bg-white rounded-[1px] p-6 shadow-sm border border-dark/10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="text-sm text-primary font-semibold hover:underline rounded-[50px]">Reset</button>
                </div>
                ...
                <button className="w-full bg-primary text-white font-bold py-3 mt-8 hover:bg-black transition-colors rounded-[50px]">
                  Apply Filters
                </button>
              </div>
            </aside>
            ...
            <div className="lg:w-3/4">
                    ...
                    >
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="flex gap-2 mt-auto">
                          <button className="flex-1 bg-white hover:bg-dark/5 text-dark border border-dark/20 py-3 font-bold transition-colors text-sm rounded-[50px]">
                            Quick View
                          </button>
                          <Link to={`/sales/${vehicle.id}`} className="flex-1 text-center bg-primary hover:bg-black text-white py-3 font-bold transition-colors text-sm shadow-md rounded-[50px]">
                            View Details
                          </Link>
                        </div>
                      </div>
              ...
              <div className="text-center mt-12">
                <button className="bg-white border border-dark/20 text-dark font-bold px-8 py-3 hover:bg-white transition-colors shadow-sm rounded-[50px]">
                  Load More Vehicles
                </button>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-[1px] p-8 md:p-12 flex flex-col justify-center border border-dark/10 shadow-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <button className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-md inline-flex items-center gap-2 rounded-[50px]">
            ...
            <div className="bg-primary text-white rounded-[1px] p-8 md:p-12 flex flex-col justify-center shadow-lg relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <button className="bg-white hover:bg-dark/5 text-primary px-8 py-4 font-bold transition-all shadow-md inline-flex items-center gap-2 rounded-[50px]">
      ...
      <section className="py-24 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <button className="hidden md:inline-flex items-center gap-2 text-primary hover:text-white font-bold transition-colors rounded-[50px]">
            ...
            {VEHICLES.slice(0, 3).map((vehicle, idx) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <Link to={`/sales/${vehicle.id}`} className="mt-auto block w-full text-center bg-white/10 hover:bg-white/20 text-white py-3 font-bold transition-colors rounded-[50px]">
                    View Offer
                  </Link>
                </div>
              </motion.div>
          ...
          <button className="md:hidden mt-8 w-full inline-flex justify-center items-center gap-2 text-accent font-bold border border-primary py-3 rounded-[50px]">
            View All Offers <ArrowRight className="w-5 h-5" />
          </button>
        </div>
      </section>
            ...
            {SALES_FAQS.map((faq, idx) => (
              ...
              >
                <button className="rounded-[50px]" 
                  ...
                  className="w-full px-6 py-5 text-left flex justify-between items-center bg-white hover:bg-dark/5 transition-colors rounded-[50px]"
                >
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl rounded-[50px]">
              View Inventory
            </button>
            <button className="bg-white hover:bg-dark/5 text-dark px-8 py-4 font-bold transition-all shadow-xl rounded-[50px]">
              Contact Sales Team
            </button>
          </div>
        </div>
