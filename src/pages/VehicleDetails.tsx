                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      ...
                      <div className="bg-primary text-white rounded-[1px] p-8 flex flex-col justify-center text-center relative overflow-hidden">
                        ...
                        <button className="w-full bg-white hover:bg-dark/5 text-dark font-bold py-4 transition-all rounded-[50px]">
                          Apply for Financing
                        </button>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-[1px] shadow-sm border border-dark/10 p-6 md:p-8">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex gap-2">
                    <button className="p-2 text-dark/70 hover:text-accent hover:bg-accent/10 rounded-[1px] transition-colors rounded-[50px]" aria-label="Save">
                      <Heart className="w-5 h-5" />
                    </button>
                    <button className="p-2 text-dark/70 hover:text-accent hover:bg-accent/10 rounded-[1px] transition-colors rounded-[50px]" aria-label="Share">
                ...
                <div className="space-y-3">
                  <button className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-md flex justify-center items-center gap-2 rounded-[50px]">
                    Book a Test Drive
                  </button>
                  <button className="w-full bg-primary hover:bg-black text-white font-bold py-4 transition-all shadow-md flex justify-center items-center gap-2 rounded-[50px]">
                    Enquire Now
                  </button>
                </div>
              </div>
               ...
               { id: 8, type: 'Foreign Used', name: '2021 Lexus RX 350', price: 'GH₵ 680,000', image: 'https://i.ibb.co/j9GzSqt8/Image-9-Car-Battery-Maintenance.jpg' }
                ...
                <div key={idx} className="bg-white rounded-[1px] overflow-hidden border border-dark/10 shadow-sm hover:shadow-lg transition-all group flex flex-col">
                  ...
                  <div className="p-6">
                    ...
                    <Link to={`/sales/${vehicle.id}`} className="block w-full text-center bg-white border border-dark/20 hover:bg-white text-dark py-3 font-bold transition-colors text-sm rounded-[50px]">
                      View Details
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-xl rounded-[50px]">
              Book a Test Drive
            </button>
