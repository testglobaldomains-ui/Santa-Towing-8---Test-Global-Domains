          ...
          <div className="max-w-2xl">
            ...
            >
              <button 
                ...
                className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-lg shadow-accent/20 rounded-[50px]"
              >
                View Open Positions
              </button>
              <a 
                href="#culture"
                className="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white px-8 py-4 font-bold transition-all rounded-[50px]"
              >
              ...
              {filteredJobs.map((job) => (
                ...
                >
                  ...
                  <div 
                    ...
                    className="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4 cursor-pointer hover:bg-white transition-colors rounded-[50px]"
                  >
                    <div>
                    ...
                    <div className="shrink-0 flex items-center gap-4">
                      {expandedJobId !== job.id && (
                        <button 
                          className="bg-primary hover:bg-black text-white px-6 py-2.5 font-bold transition-all hidden sm:block rounded-[50px]"
                          onClick={(e) => {
                            e.stopPropagation();
                            ...
                            <div className="bg-white p-6 rounded-[1px] border border-dark/20 shadow-sm sticky top-32">
                              ...
                              {!isApplyingFor || isApplyingFor !== job.id ? (
                                <button className="rounded-[50px]" 
                                  ...
                                  className="w-full bg-accent hover:bg-accent/90 text-white px-6 py-4 font-bold transition-all shadow-lg flex justify-center items-center gap-2 text-lg rounded-[50px]"
                                >
                      ...
                      >
                        <div className="p-6 md:p-10 border-t border-white/20 relative">
                          <button className="rounded-[50px]" 
                            ...
                            className="absolute top-6 right-6 p-2 bg-white/10 hover:bg-white/20 rounded-[1px] transition-colors rounded-[50px]"
                          >
                            <X className="w-5 h-5" />
                          </button>
                            ...
                            <form onSubmit={handleApply} className="space-y-6">
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="border-2 border-dashed border-white/20 rounded-[1px] p-6 text-center hover:border-accent/50 transition-colors bg-white/5">
                                  ...
                                  <button type="button" className="text-accent font-bold text-sm hover:underline rounded-[50px]">Browse files</button>
                              ...
                              <button 
                                ...
                                className="bg-accent hover:bg-accent/90 text-white font-bold px-8 py-4 transition-all shadow-lg flex items-center justify-center gap-2 w-full md:w-auto disabled:opacity-50 rounded-[50px]"
                              >
      ...
      <section className="py-20 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button 
              onClick={scrollToJobs}
              className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-xl text-lg rounded-[50px]"
            >
              View Open Positions
            </button>
            <Link to="/contact" className="bg-white/10 hover:bg-white/20 border border-white/20 text-white px-8 py-4 font-bold transition-all shadow-xl text-lg rounded-[50px]">
