        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                <a href="tel:0244753849" className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-lg shadow-accent/30 flex items-center justify-center gap-3 text-lg rounded-[50px]">
                ...
                <>
                  ...
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="relative">
                      ...
                      <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-primary p-1 hover:bg-accent/10 rounded-[1px] transition-colors rounded-[50px]" title="Use My Location">
                    ...
                    <button disabled={formState === 'submitting'} className="w-full bg-primary hover:bg-black text-white font-bold py-4 transition-all shadow-lg flex items-center justify-center gap-2 mt-2 disabled:opacity-70 rounded-[50px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <button className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-lg inline-flex items-center gap-2 rounded-[50px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <Link to={service.link} key={idx} className="bg-white/5 border border-white/10 p-6 rounded-[1px] hover:bg-accent hover:border-accent transition-all group flex items-start gap-4 rounded-[50px]">
      ...
      <section className="py-20 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="tel:0244753849" className="w-full sm:w-auto bg-primary hover:bg-black text-white px-8 py-5 font-bold transition-all shadow-xl flex items-center justify-center gap-3 text-lg rounded-[50px]">
              <Phone className="w-6 h-6" /> Call 0244753849
            </a>
            <button className="w-full sm:w-auto bg-white hover:bg-dark/5 text-dark px-8 py-5 font-bold transition-all shadow-xl flex items-center justify-center gap-3 text-lg rounded-[50px]">
