                        ...
                        return (
                          <div key={idx} className="border border-dark/20 rounded-[1px] overflow-hidden shadow-sm bg-white hover:border-accent/30 transition-colors">
                            <button className="rounded-[50px]" 
                              ...
                              className="w-full px-6 py-5 text-left flex justify-between items-center bg-white hover:bg-dark/5 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-accent rounded-[50px]"
                    ...
                    <AnimatePresence>
                      {isOpen && (
                        ...
                        >
                          <div className="px-6 py-5 text-dark/80 border-t border-dark/10 leading-relaxed text-sm md:text-base">
                            <div className="mb-3">
                              <span className="inline-block bg-primary text-white text-[10px] font-bold tracking-wider uppercase px-2 py-1">
                                {faq.category}
                              </span>
                            </div>
                            {faq.a}
      ...
      <section className="py-20 bg-white border-t border-dark/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/contact" className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-[50px]">
              <Phone className="w-5 h-5" /> Contact Support
            </Link>
            <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-primary/50 hover:bg-accent text-white px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-[50px]">
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/booking" className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl text-lg inline-block rounded-[50px]">
              Book a Service
            </Link>
            <Link to="/contact" className="bg-white hover:bg-dark/5 text-dark px-8 py-4 font-bold transition-all shadow-xl text-lg rounded-[50px]">
              Contact Us
            </Link>
          </div>
        </div>
