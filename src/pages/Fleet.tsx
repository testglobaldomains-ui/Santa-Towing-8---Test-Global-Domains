      ...
      <section className="relative bg-primary text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="max-w-3xl">
            ...
            >
              <button className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-lg shadow-accent/20 rounded-[50px]">
                Request a Fleet Consultation
              </button>
              <button className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/20 px-8 py-4 font-bold transition-all rounded-[50px]">
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl text-lg rounded-[50px]">
              Request a Consultation
            </button>
            <button className="bg-white hover:bg-dark/5 text-dark px-8 py-4 font-bold transition-all shadow-xl text-lg rounded-[50px]">
              Contact Sales
            </button>
          </div>
        </div>
