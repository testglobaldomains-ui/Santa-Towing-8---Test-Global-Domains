          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="bg-primary rounded-[1px] p-8 md:p-12 text-white mb-12 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <button className="w-full md:w-auto bg-accent hover:bg-accent/90 text-white font-bold px-8 py-4 transition-all whitespace-nowrap shadow-lg rounded-[50px]">
                  Book Installation
                </button>
              </div>
            </div>
            ...
            <div className="mb-12">
              <div className="flex items-end justify-between mb-8">
                ...
                <button className="text-accent font-bold hover:text-accent transition-colors hidden md:block rounded-[50px]">
                  Write a Review
                </button>
              </div>
            ...
            <div className="bg-white rounded-[1px] p-6 md:p-8 border border-dark/10 shadow-xl lg:sticky lg:top-32">
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-2 text-dark/70">
                  <button className="hover:text-accent transition-colors rounded-[50px]"><Heart className="w-5 h-5" /></button>
                  <button className="hover:text-accent transition-colors rounded-[50px]"><Share2 className="w-5 h-5" /></button>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mb-6 border-b border-dark/10 pb-6">
                ...
                <div className="flex items-center bg-white rounded-[1px] border border-dark/20">
                  <button className="rounded-[50px]" onClick={() => setQty(Math.max(1, qty - 1))} className="p-2 hover:text-accent transition-colors"><Minus className="w-4 h-4" /></button>
                  <span className="w-12 text-center font-bold text-dark">{qty}</span>
                  <button className="rounded-[50px]" onClick={() => setQty(qty + 1)} className="p-2 hover:text-accent transition-colors"><Plus className="w-4 h-4" /></button>
                </div>
              </div>

              {/* Action Buttons */}
              <div className="space-y-3 mb-6">
                <button className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-md flex items-center justify-center gap-2 rounded-[50px]">
                  <ShoppingCart className="w-5 h-5" /> Add to Cart
                </button>
                <button className="w-full bg-primary hover:bg-black text-white font-bold py-4 transition-all shadow-md rounded-[50px]">
                  Get a Quote
                </button>
              </div>
