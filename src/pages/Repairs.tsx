    ...
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-20 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Link to="/booking" className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-lg shadow-accent/30 flex items-center justify-center rounded-[50px]">
              Book for Repair
            </Link>
            <a href="tel:0244753849" className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md px-8 py-4 font-bold transition-all border border-white/20 flex items-center justify-center gap-2 rounded-[50px]">
                ...
                >
                  ...
                  <div className="mt-auto pt-4 border-t border-dark/10 space-y-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <Link to={service.href || "/booking"} className="flex-1 bg-primary hover:bg-black text-white text-center py-2 px-2.5 text-xs font-bold transition-all flex items-center justify-center rounded-[50px]">
                        <span>{service.href ? "Learn More" : "Book for Repair"}</span>
                      </Link>
                      <a href="tel:0244753849" className="flex-1 bg-accent hover:bg-accent/90 text-white text-center py-2 px-2.5 text-xs font-bold transition-all flex items-center justify-center gap-1 shadow-sm rounded-[50px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {MAINTENANCE_PACKAGES.map((pkg, idx) => (
              <motion.div
                ...
                transition={{ delay: idx * 0.1 }}
                className={cn(
                  "rounded-[1px] p-6 flex flex-col shadow-sm transition-transform hover:-translate-y-2",
              ...
              >
                ...
                <button className={cn(
                  "w-full py-4 rounded-[50px] font-bold transition-all mt-auto",
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl bg-primary rounded-[1px] p-6 md:p-12 shadow-2xl">
            ...
            <form className="space-y-4" onSubmit={e => { e.preventDefault(); (e.target as HTMLFormElement).reset(); alert('Appointment booked successfully! We will contact you shortly.'); }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button type="submit" className="flex-1 bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-lg text-center rounded-[50px]">
                  Book for Repair
                </button>
                <a href="tel:0244753849" className="flex-1 bg-white hover:bg-white/90 text-dark font-bold py-4 transition-all shadow-lg flex items-center justify-center gap-2 text-center rounded-[50px]">
            ...
            {REPAIR_FAQS.map((faq, idx) => (
              ...
              >
                <button className="rounded-[50px]" 
                  ...
                  className="w-full px-6 py-5 text-left flex justify-between items-center hover:bg-dark/5 transition-colors rounded-[50px]"
                >
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/booking" className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-[50px]">
              Book for Repair
            </Link>
            <a href="tel:0244753849" className="bg-accent hover:bg-accent/90 text-white px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-[50px]">
              <Phone className="w-4 h-4" />
              <span>Call for Repair</span>
            </a>
          </div>
