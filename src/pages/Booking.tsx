    ...
    return (
      ...
      <SEO title="Book an Auto Service Online | Santa Towing" description="Easily schedule an appointment for auto repairs, servicing, or vehicle consultation with our certified mechanics." canonical="/booking" />
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="bg-white rounded-[1px] p-6 border border-dark/10 shadow-sm mb-8 text-left max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-md flex items-center justify-center gap-2 rounded-[50px]">
              <CalendarPlus className="w-5 h-5" /> Add to Calendar
            </button>
            <Link to="/" className="bg-white hover:bg-dark/5 text-dark border border-dark/20 px-8 py-4 font-bold transition-all shadow-sm rounded-[50px]">
              Return Home
            </Link>
          </div>
              ...
              <div className="bg-white rounded-[1px] p-6 md:p-10 border border-dark/10 shadow-sm min-h-[500px] flex flex-col">
                ...
                <div className="flex items-center justify-between mt-auto pt-8 border-t border-dark/10">
                  <button 
                    onClick={handleBack}
                    className={cn(
                      "font-bold px-6 py-3 rounded-[50px] transition-all flex items-center gap-2",
                  ...
                  {step < 5 ? (
                    <button 
                      onClick={handleNext}
                      disabled={!canProceed()}
                      className="bg-primary hover:bg-black text-white font-bold px-8 py-3 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-md rounded-[50px]"
                    >
                    ...
                    <button 
                      ...
                      className="bg-accent hover:bg-accent/90 text-white font-bold px-8 py-3 transition-all flex items-center gap-2 shadow-md shadow-accent/20 rounded-[50px]"
                    >
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-primary text-white rounded-[1px] p-8 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                <a href="tel:0244753849" className="flex items-center gap-4 bg-primary hover:bg-black p-4 rounded-[1px] transition-colors border border-white/20 rounded-[50px]">
                ...
                <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-white text-dark hover:bg-white p-4 rounded-[1px] transition-colors rounded-[50px]">
