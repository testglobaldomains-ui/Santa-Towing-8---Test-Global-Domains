      ...
      <section className="relative bg-primary overflow-hidden pt-16 pb-24 md:pt-24 md:pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            />
            <button type="submit" className="bg-accent hover:bg-accent/90 text-white px-6 py-3 font-bold transition-all rounded-[50px]">
              Search
            </button>
          </motion.form>
        </div>
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 relative overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6 z-20">
                    <span className="bg-accent text-white text-xs font-bold px-3 py-1.5 uppercase tracking-wider shadow-lg rounded-[50px]">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-2/3">
            ...
            {displayedPosts.length === 0 ? (
              <div className="text-center py-20 bg-slate-50 rounded-[1px] border border-dark/5">
                  ...
                  >
                    <Link to={`/blog/${post.id}`} className="relative aspect-[16/10] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <div className="bg-white/90 backdrop-blur-md px-3 py-1 text-xs font-bold text-dark shadow-sm rounded-[50px]">
                          {post.category}
                        </div>
                      </div>
                    </Link>
            ...
            {hasMore && (
              <div className="flex justify-center">
                <button className="rounded-[50px]" 
                  ...
                  className="bg-white hover:bg-dark/5 border border-dark/20 text-dark font-bold px-8 py-4 shadow-sm transition-colors flex items-center gap-2 rounded-[50px]"
                >
            ...
            <div className="bg-primary rounded-[1px] p-8 text-white relative overflow-hidden shadow-xl">
              ...
              <form className="space-y-3" onSubmit={e => { e.preventDefault(); (e.target as HTMLFormElement).reset(); alert('Subscribed successfully!'); }}>
                <input 
                  ...
                  required
                />
                <button type="submit" className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-3 transition-colors text-sm shadow-md rounded-[50px]">
                  Subscribe Now
                </button>
              </form>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {TAGS.map((tag, idx) => (
                  <button className="rounded-[50px]" 
                    ...
                    className="bg-slate-100 hover:bg-accent hover:text-white text-dark/70 text-xs font-bold px-3 py-1.5 transition-colors rounded-[50px]"
                  >
                    {tag}
                  </button>
                ))}
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="bg-accent hover:bg-red-700 text-white px-8 py-4 font-bold transition-all shadow-xl rounded-[50px]">
              Contact Us Immediately
            </Link>
            <a href="tel:0244753849" className="bg-white hover:bg-slate-100 text-primary px-8 py-4 font-bold transition-all shadow-xl rounded-[50px]">
              Call 0244 753 849
            </a>
          </div>
        </div>
