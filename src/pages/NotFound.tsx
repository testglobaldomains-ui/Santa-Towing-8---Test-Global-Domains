    ...
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
        ...
        <form onSubmit={handleSearch} className="max-w-md mx-auto mb-12 relative">
          ...
          <button type="submit" className="hidden rounded-[50px]">Search</button>
        </form>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="rounded-[50px]" 
            onClick={() => navigate(-1)}
            className="w-full sm:w-auto bg-white border border-dark/20 hover:border-dark text-dark px-8 py-4 font-bold flex items-center justify-center gap-3 transition-colors"
          >
          ...
          <Link 
            to="/" 
            className="w-full sm:w-auto bg-primary hover:bg-black text-white px-8 py-4 font-bold flex items-center justify-center gap-3 transition-colors rounded-[50px]"
          >
