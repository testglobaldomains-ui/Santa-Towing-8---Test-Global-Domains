  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-24 pb-16 md:pb-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white rounded-[1px] shadow-sm border border-dark/10 p-6 md:p-10 mb-8">
          ...
          <form onSubmit={handleSearch} className="relative">
            <div className="relative">
              ...
              <button 
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-primary hover:bg-black text-white px-4 sm:px-6 py-2 sm:py-2.5 text-sm sm:text-base font-bold transition-colors rounded-[50px]"
              >
                Search
              </button>
            </div>
          ...
          <div className="space-y-6">
            ...
            {results.length > 0 ? (
              ...
              <motion.div 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-white p-12 rounded-[1px] text-center border border-dark/10 border-dashed"
              >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  <Link to="/towing" className="bg-slate-50 hover:bg-primary/10 hover:text-primary text-dark px-5 py-2.5 font-semibold transition-colors text-sm rounded-[50px]">
                    Towing Services
                  </Link>
                  <Link to="/repairs" className="bg-slate-50 hover:bg-primary/10 hover:text-primary text-dark px-5 py-2.5 font-semibold transition-colors text-sm rounded-[50px]">
                    Auto Repairs
                  </Link>
                  <Link to="/contact" className="bg-slate-50 hover:bg-primary/10 hover:text-primary text-dark px-5 py-2.5 font-semibold transition-colors text-sm rounded-[50px]">
                    Contact Us
                  </Link>
                </div>
              </motion.div>
