            ...
            {RENTAL_CATEGORIES.map((category, idx) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <button className="w-full bg-white hover:bg-accent hover:text-white text-dark py-4 font-bold transition-colors rounded-[50px]">
                    View Vehicles
                  </button>
                </div>
              </motion.div>
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex gap-2 mt-auto">
                      ...
                      <button className="flex-1 bg-accent hover:bg-accent/90 text-white py-3 font-bold transition-colors text-sm shadow-md rounded-[50px]">
                        Book Now
                      </button>
                    </div>
                  </div>
