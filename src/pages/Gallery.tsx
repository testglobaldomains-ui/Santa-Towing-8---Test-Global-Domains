              ...
              {filteredImages.map((image, idx) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    <span className="bg-primary text-white text-xs font-bold px-2 py-1 self-start mb-2 rounded-[50px]">
                      {image.category}
                    </span>
        ...
        {lightboxIndex !== null && (
          ...
          >
            <button 
              ...
              className="absolute top-6 right-6 text-white/70 hover:text-white transition-colors bg-white/10 rounded-[1px] p-2 rounded-[50px]"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <button 
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white transition-colors bg-white/10 hover:bg-accent rounded-[1px] p-3 rounded-[50px]"
            >
            ...
            <button 
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white transition-colors bg-white/10 hover:bg-accent rounded-[1px] p-3 rounded-[50px]"
            >
            ...
            {VIDEOS.map((video) => (
              <div key={video.id} className="group relative rounded-[1px] overflow-hidden aspect-video bg-white cursor-pointer shadow-sm hover:shadow-xl transition-all border border-dark/10">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                  ...
                  <span className="bg-primary/80 backdrop-blur-md text-white text-xs font-bold px-2 py-1 flex items-center gap-1 rounded-[50px]">
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/contact" className="bg-white hover:bg-dark/5 text-dark px-8 py-4 font-bold transition-all shadow-xl text-lg flex items-center gap-2 rounded-[50px]">
