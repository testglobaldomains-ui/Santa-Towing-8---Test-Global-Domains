      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-3/5">
            <div className="bg-white rounded-[1px] p-6 md:p-12 border border-dark/10 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed rounded-[50px]"
                >
            ...
            {LOCATIONS.map((loc) => (
              <div key={loc.id} className="bg-white rounded-[1px] p-4 border border-dark/10 flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-3/5 py-2 flex flex-col justify-center pr-4">
                  ...
                  <button className="bg-primary hover:bg-black text-white px-6 py-2 font-bold transition-colors text-sm self-start rounded-[50px]">
                    Get Directions
                  </button>
                </div>
              </div>
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:0244753849" className="bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-xl flex items-center gap-2 rounded-[50px]">
              <Phone className="w-5 h-5" /> Call Now
            </a>
            <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-dark/5 text-[#25D366] px-8 py-4 font-bold transition-all shadow-xl flex items-center gap-2 rounded-[50px]">
