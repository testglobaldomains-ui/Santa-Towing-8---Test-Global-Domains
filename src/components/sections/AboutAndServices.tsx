        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link 
                to="/services" 
                className="bg-primary hover:bg-secondary text-white px-7 py-3.5 font-bold transition-all duration-200 flex items-center gap-2 shadow-md hover:-translate-y-0.5 rounded-[50px]"
              >
              ...
              <a 
                href="tel:0244753849" 
                className="bg-accent hover:bg-accent/90 text-white px-7 py-3.5 font-bold transition-all duration-200 shadow-md shadow-accent/25 hover:-translate-y-0.5 rounded-[50px]"
              >
    ...
    <section className="py-16 md:py-20 lg:py-24 bg-slate-50/70 relative border-y border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="p-6 sm:p-7 flex-1 flex flex-col relative">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 space-y-3">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <Link 
                        to={linkHref} 
                        className="flex-1 bg-primary hover:bg-black text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm flex items-center justify-center gap-1 min-h-[40px] rounded-[50px]"
                      >
                        <span>Book for Repair</span>
                      </Link>
                      <a 
                        href="tel:0244753849" 
                        className="flex-1 bg-accent hover:bg-accent/90 text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm shadow-accent/20 flex items-center justify-center gap-1.5 min-h-[40px] rounded-[50px]"
                      >
        ...
        <div className="mt-14 text-center">
          <Link 
            to="/services" 
            className="bg-accent hover:bg-accent/90 text-white px-8 sm:px-10 py-4 font-bold transition-all shadow-md shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 inline-flex items-center gap-2 rounded-[50px]"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                to="/towing" 
                className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-black text-white px-8 py-4 font-bold transition-all shadow-md hover:-translate-y-0.5 rounded-[50px]"
              >
              ...
              <Link 
                to="/service-areas" 
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 border border-dark/20 text-dark px-8 py-4 font-bold transition-all shadow-sm hover:-translate-y-0.5 rounded-[50px]"
              >
