    ...
    <section className="py-16 md:py-20 lg:py-24 bg-secondary text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                ...
                <div className="p-5 sm:p-6 flex-1 flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-auto">
                    ...
                    <Link 
                      to="/contact" 
                      className="bg-accent hover:bg-accent/90 text-white py-2.5 font-bold transition-all text-xs sm:text-sm text-center flex items-center justify-center shadow-md shadow-accent/20 rounded-[50px]"
                    >
                      Inquire
                    </Link>
                  </div>
        ...
        <div className="mt-12 text-center">
          <Link 
            to="/sales" 
            className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-8 py-3.5 font-bold transition-all border border-white/20 hover:border-white/40 group rounded-[50px]"
          >
          ...
          {RENTAL_CATEGORIES.map((category, idx) => (
            ...
            >
              ...
              <div className="p-6 sm:p-7 flex-1 flex flex-col">
                ...
                <Link 
                  to="/rental" 
                  className="w-full bg-primary hover:bg-secondary text-white py-3.5 font-bold transition-all text-center flex items-center justify-center gap-2 shadow-md hover:-translate-y-0.5 mt-auto rounded-[50px]"
                >
