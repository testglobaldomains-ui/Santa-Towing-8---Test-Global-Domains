        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a 
                href="tel:0244753849" 
                className="bg-accent hover:bg-accent/90 text-white px-7 py-3.5 font-bold transition-all shadow-lg shadow-accent/30 hover:-translate-y-0.5 flex items-center gap-2 rounded-[50px]"
              >
              ...
              <Link 
                to="/towing" 
                className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-7 py-3.5 font-bold transition-all border border-white/20 hover:-translate-y-0.5 rounded-[50px]"
              >
                Request Tow Online
              </Link>
            </div>
          ...
          {FAQS.map((faq, idx) => (
            ...
            >
              <button className="rounded-[50px]" 
                ...
                className="w-full px-6 py-5 text-left flex justify-between items-center bg-white hover:bg-slate-50 transition-colors gap-4 rounded-[50px]"
              >
