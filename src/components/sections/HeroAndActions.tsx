  ...
  return (
    <div className="relative min-h-[640px] md:min-h-[700px] lg:h-[88vh] w-full overflow-hidden bg-dark">
              ...
              <div className="max-w-2xl lg:max-w-3xl">
                ...
                >
                  {HERO_SLIDES[currentSlide].buttons.map((btn, idx) => {
                    ...
                    const className = cn(
                      "px-6 sm:px-8 py-3.5 sm:py-4 rounded-[50px] font-bold text-sm sm:text-base transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:-translate-y-0.5",
                      btn.primary 
      ...
      <div className="absolute top-1/2 -translate-y-1/2 w-full px-4 sm:px-6 lg:px-8 flex justify-between pointer-events-none z-20">
        <button 
          onClick={prevSlide}
          className="pointer-events-auto w-11 h-11 sm:w-12 sm:h-12 bg-dark/60 hover:bg-accent text-white flex items-center justify-center backdrop-blur-md transition-all border border-white/15 shadow-lg hover:scale-105 rounded-[50px]"
