    ...
    <section className="py-16 md:py-20 lg:py-24 bg-slate-50/70 relative border-t border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-14">
          ...
          <Link 
            to="/parts" 
            className="bg-primary hover:bg-secondary text-white px-7 py-3.5 font-bold transition-all inline-flex items-center gap-2 whitespace-nowrap shadow-md hover:-translate-y-0.5 rounded-[50px]"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-gradient-to-r from-primary to-secondary p-8 sm:p-10 rounded-[1px] border border-white/10 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 shrink-0">
            <a 
              href="tel:0244753849" 
              className="bg-accent hover:bg-accent/90 text-white px-7 py-3.5 font-bold transition-all shadow-lg shadow-accent/30 hover:-translate-y-0.5 flex items-center gap-2 text-sm sm:text-base rounded-[50px]"
            >
            ...
            <Link 
              to="/towing" 
              className="bg-white/15 hover:bg-white/25 text-white px-7 py-3.5 font-bold transition-all border border-white/20 hover:-translate-y-0.5 text-sm sm:text-base rounded-[50px]"
            >
              Request Tow Online
            </Link>
          </div>
