        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-14">
          ...
          <div>
            ...
            <form className="space-y-3" onSubmit={(e) => { e.preventDefault(); (e.target as HTMLFormElement).reset(); alert('Subscribed successfully!'); }}>
              ...
              <button 
                type="submit" 
                className="w-full bg-accent hover:bg-accent/90 text-white font-bold px-4 py-3 text-sm transition-all shadow-md shadow-accent/25 hover:-translate-y-0.5 rounded-[50px]"
              >
                Subscribe Now
              </button>
            </form>
