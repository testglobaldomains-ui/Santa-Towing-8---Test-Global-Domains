    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-52 bg-white text-dark rounded-[1px] shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 overflow-hidden border border-gray-100 p-1.5 z-50">
              {towingServices.map(s => (
                <Link 
                  key={s.title} 
                  to={s.path} 
                  className="block px-3.5 py-2.5 hover:bg-slate-50 hover:text-accent transition-colors text-sm font-medium rounded-[50px]"
                >
                  {s.title}
                </Link>
              ))}
        ...
        <nav className="hidden lg:flex xl:hidden items-center gap-4 font-medium text-sm">
          ...
          <div className="relative group cursor-pointer">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-48 bg-white text-dark rounded-[1px] shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 overflow-hidden border border-gray-100 p-1.5 z-50">
              <Link to="/sales" onClick={() => setMobileMenuOpen(false)} className="block px-3.5 py-2.5 hover:bg-slate-50 hover:text-accent transition-colors text-sm font-medium rounded-[50px]">Cars for Sale</Link>
              <Link to="/rental" onClick={() => setMobileMenuOpen(false)} className="block px-3.5 py-2.5 hover:bg-slate-50 hover:text-accent transition-colors text-sm font-medium rounded-[50px]">Rental Fleet</Link>
            </div>
          </div>
          ...
          <div className="relative group cursor-pointer">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-48 bg-white text-dark rounded-[1px] shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 overflow-hidden border border-gray-100 p-1.5 z-50">
              <Link to="/gallery" onClick={() => setMobileMenuOpen(false)} className="block px-3.5 py-2.5 hover:bg-slate-50 hover:text-accent transition-colors text-sm font-medium rounded-[50px]">Gallery</Link>
              <Link to="/blog" onClick={() => setMobileMenuOpen(false)} className="block px-3.5 py-2.5 hover:bg-slate-50 hover:text-accent transition-colors text-sm font-medium rounded-[50px]">Blog</Link>
              <Link to="/sitemap" onClick={() => setMobileMenuOpen(false)} className="block px-3.5 py-2.5 hover:bg-slate-50 hover:text-accent transition-colors text-sm font-medium rounded-[50px]">Sitemap</Link>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3">
          <Link 
            to="/search" 
            className="hidden sm:flex items-center justify-center p-2.5 rounded-[1px] hover:bg-white/10 transition-colors text-inherit rounded-[50px]"
            aria-label="Search"
          >
          ...
          <a 
            href="tel:0244753849" 
            className="hidden sm:inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white px-5 py-2.5 font-semibold text-sm transition-all shadow-md shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 rounded-[50px]"
          >
            <Phone className="w-4 h-4" />
            <span>Call Now: 0244753849</span>
          </a>
          <button 
            className="lg:hidden p-2 text-inherit rounded-[1px] hover:bg-white/10 transition-colors rounded-[50px]"
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col p-4 font-medium divide-y divide-gray-100 max-h-[calc(100vh-80px)] overflow-y-auto">
              <Link to="/" onClick={() => setMobileMenuOpen(false)} className="py-3 px-4 hover:text-accent hover:bg-slate-50 transition-colors shrink-0 rounded-[50px]">Home</Link>
              <Link to="/search" onClick={() => setMobileMenuOpen(false)} className="py-3 px-4 hover:text-accent hover:bg-slate-50 transition-colors shrink-0 flex items-center gap-2 rounded-[50px]">
              ...
              <Link 
                ...
                className="py-3 px-4 hover:text-accent hover:bg-slate-50 transition-colors shrink-0 flex items-center justify-between font-bold text-accent rounded-[50px]"
              >
                <span>Haulage Services</span>
                <span className="text-[10px] bg-accent/10 text-accent px-2 py-0.5 font-bold uppercase">Heavy Transport</span>
              </Link>
              ...
              <div className="flex flex-col shrink-0">
                <button className="rounded-[50px]" 
                  ...
                  className="flex justify-between items-center py-3 px-4 hover:text-accent hover:bg-slate-50 transition-colors w-full text-left rounded-[50px]"
                >
              ...
              <Link to="/contact" onClick={() => setMobileMenuOpen(false)} className="py-3 px-4 hover:text-accent hover:bg-slate-50 transition-colors shrink-0 rounded-[50px]">Contact</Link>
              
              <div className="pt-4 pb-2 px-2 shrink-0">
                <a 
                  href="tel:0244753849" 
                  onClick={() => setMobileMenuOpen(false)} 
                  className="w-full bg-accent hover:bg-accent/90 text-white px-6 py-3.5 font-semibold transition-all text-center flex items-center justify-center gap-2 shadow-md rounded-[50px]"
                >
                  <Phone className="w-4 h-4" />
                  <span>Call Now: 0244753849</span>
                </a>
